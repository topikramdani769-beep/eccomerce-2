    ...
    <header v-if="showNavbar" class="navbar">
      <div class="nav-container">
        ...
        <nav class="nav-links">
          ...
          <router-link to="/cart" class="nav-item nav-icon-item cart-link">
          ...
          <Teleport to="body">
            <Transition name="toast-fade">
              <div v-if="showToast" class="realtime-toast">
            ...
            <div class="modal-grid">
              ...
              <div class="modal-info-col">
                ...
                <div class="modal-actions">
                  <button @click.stop="addToCart(selectedProduct)" class="btn-add-cart">
                    ADD TO CART
                    </button>
                </div>
              </div>
...
// Reaktivitas Auth & Cart Store
const { isAuthenticated, user } = storeToRefs(authStore);
const { totalItems: cartTotalItems, showToast, toastMessage } = storeToRefs(cartStore);
...
onMounted(async () => {
  ...
  // Sinkronisasi data user jika token ada di LocalStorage
  if ((localStorage.getItem('auth_token') || localStorage.getItem('token')) && !user.value) {
    try {
